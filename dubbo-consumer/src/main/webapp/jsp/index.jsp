...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
   	...
   	<meta name="description" content="东宝金融网是东宝教育集团旗下一站式互联网金融平台.接入支付清算协会风险系统，用互联网技术和金融创新使投资与借贷更透明、更高效.优选互联网金融产品随心选。"/>
    <title>东宝金融网官网-专业的互联网金融信息服务平台</title>
...
<!-- 页头start -->
<div id="header">
<jsp:include page="${pageContext.request.contextPath}/commons/header.jsp"/>
</div>
<!--页头end-->
...
<div class="flashImg">
    ...
    <div class="registerBody">
        ...
        <div class="register welcome">
            <div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来东宝金融网投资！</div>
...
<div id="productArea">
	...
	<div class="pro-more"><i class="left-i"></i><a href="${pageContext.request.contextPath}/loan/loan?ptype=2">查看更多散标类产品</a><i class="right-i"></i></div>
	<!-- 散标end -->
</div>
<!--投资产品end-->
...
<!--页脚start-->
<jsp:include page="${pageContext.request.contextPath}/commons/footer.jsp"/>
<!--页脚end-->
