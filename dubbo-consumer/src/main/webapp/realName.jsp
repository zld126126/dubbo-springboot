...
<title>实名认证东宝金融网-东宝金融网,专业的互联网金融信息服务平台</title>
</head>
        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="remember" style="z-index:60;">
                <span class="on">
                <input id="agree" name="agree" type="checkbox"/>我已阅读并同意<a href="javascript:alertBox('mask','agreement');"><font style="color: red;">《东宝金融网&trade;实名认证服务协议》</font></a>
                </span>
              </div>
              <div class="bn-login">
                <button class="fail" id="btnRegist" disabled onclick="javascript:realName();">认&nbsp;&nbsp;证</button>
              </div>
          </div>
        </div>
        <div class="reg-right">
