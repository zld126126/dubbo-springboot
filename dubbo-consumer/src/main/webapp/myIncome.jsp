      ...
      <dl>
       ...
       <span class="deal-balance">收益状态</span>
		...
		<c:choose>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myIncome">首页</a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myIncome?currentPage=${currentPage-1}">上一页</a>
			</c:otherwise>
			</c:choose>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myIncome?currentPage=${currentPage+1}">下一页 </a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myIncome?currentPage=${totalPage}">尾页</a>
			</c:otherwise>
			</c:choose>
		</div>
      </dl>
