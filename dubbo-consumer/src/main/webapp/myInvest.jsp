      ...
      <dl>
       ...
       <c:forEach items="${bidInfoList}" var="bidInfo">
		...
		<c:choose>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myInvest">首页</a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myInvest?currentPage=${currentPage-1}">上一页</a>
			</c:otherwise>
			</c:choose>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myInvest?currentPage=${currentPage+1}">下一页 </a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/myInvest?currentPage=${totalPage}">尾页</a>
			</c:otherwise>
			</c:choose>
		</div>
      </dl>
